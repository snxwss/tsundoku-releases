...
contextBridge.exposeInMainWorld('api', {
  ...
  vndbStatus:  ()             => ipcRenderer.invoke('vndb-status'),
  ...
  // VNDB list import
  vndbImportFetch:    (opts)  => ipcRenderer.invoke('vndb-import-fetch', opts),
  libraryImportBatch: (batch) => ipcRenderer.invoke('library-import-batch', batch),
